...
public class CarRacer extends Application {
   ...
   public Parent setupGame() {
      ...
      VBox info = new VBox();
      info.setPrefWidth(sceneWidth);
      info.setPrefHeight(sceneHeight);
   
      lblLeaderboard.setBackground(new Background(new BackgroundFill(Color.rgb(255, 255, 255, 0.7), new CornerRadii(5.0), new Insets(-2.0))));
      info.setAlignment(Pos.TOP_RIGHT);
      info.getChildren().add(lblLeaderboard);

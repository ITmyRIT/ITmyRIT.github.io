...
public class CarRacer extends Application {
   ...
   public Parent setupGame() {
      ...
      lblLeaderboard.setBackground(new Background(new BackgroundFill(Color.rgb(255, 255, 255, 0.7), new CornerRadii(5.0), new Insets(-4.0))));
      leadBox.setAlignment(Pos.BOTTOM_RIGHT);
      leadBox.setMargin(lblLeaderboard, new Insets(0, sceneWidth/4, 0, 0));
      ...
      lblChat.setBackground(new Background(new BackgroundFill(Color.rgb(255, 255, 255, 0.7), new CornerRadii(5.0), new Insets(-4.0))));
      tfChat.setBackground(new Background(new BackgroundFill(Color.rgb(255, 255, 255, 0.7), new CornerRadii(5.0), new Insets(-4.0))));
      tfChat.setStyle("-fx-border-color:#ffffff00;");
      chatBox.setAlignment(Pos.TOP_LEFT);
      chatBox.setMargin(lblChat, new Insets(0, 0, 0, sceneWidth/4));
      chatBox.setMargin(tfChat, new Insets(10, 0, 0, sceneWidth/4));
         ...
         key -> {
            ...
            switch (key.getCode()) {
               ...
               case ENTER:
                  ...
                  race.getClient().sendChat(tfChat.getText());
                  tfChat.clear();
